    ...
    <aside :style="[extended ? 'width: 0' : '']">
        ...
        <div class="nav">
            ...
            <ul>
                ...
                <div class="bottom">
                    <router-link :to="{name: 'SchoolProfile'}">
...
export default {
    ...
    data() {
        return {
            extended: false,
            list: [
                ["schoolHome", "fa-solid fa-home", "home"],
                ["schoolSubjects", "fa-solid fa-flask", "subjects"],
                ["schoolClasses", "fa-solid fa-list", "classes"],
                ["schoolRooms", "fa-solid fa-landmark", "rooms"],
                ["schoolTeachers", "fa-solid fa-person-chalkboard", "Teachers"],
                ["schoolAbsence", "fa-solid fa-list", "Absence"],
                ["schoolSchedule", "fa-solid fa-calendar", "Schedule"],
                ["schoolResult", "fa-solid fa-chart-simple", "results"],
            ]
        };
    },
